/* Wonder Inventory Data-Quality Console — APPROVED build (Variant A base + Variant C dashboard).
...
(function () {
  ...
  // ---- Inventory movement types (ledger movement categories) ----
  // Used for the "Errors by inventory movement type" dashboard breakout.
  const movementTypes = ["PO Receipt", "Transfer", "Production", "Sales / Outbound", "Expiration", "Adjustment"];
  ...
  // `subAssign` (optional) demonstrates the ownership-transfer concept: the primary owner stays
  // accountable but hands the work to the root-cause team. SLA does NOT reset on hand-off.
  const exceptions = [
    {
    ...
    },
    {
      ...
      // Ownership transfer: DE is primary owner, but the root cause is a missing PO from Procurement.
      subAssign: { toTeam: "Procurement", toPerson: "Tom Becker", at: "2026-06-07T15:10Z",
        byPerson: "Pavel Romanov", slaRemainingDays: 2,
        note: "Receipt has no PO — needs Procurement to create/attach the PO. Primary owner (Data Eng) stays accountable; SLA clock keeps running." },
      ...
      rule: "R-001",
      timeline: tl([["Open", "2026-06-07T07:01Z", "batch-validator"], ["Sub-assigned → Procurement (Tom Becker)", "2026-06-07T15:10Z", "Pavel Romanov"]])
    },
    {
    ...
    },
    {
      ...
      // Ownership transfer example #2: Inventory Ops primary, root cause is a Field Ops receiving miss.
      subAssign: { toTeam: "Field Ops", toPerson: "DIS-DAL-02 Manager", at: "2026-05-28T10:00Z",
        byPerson: "Priya Nair", slaRemainingDays: 1,
        note: "Aged stock stranded in Transfer Warehouse — destination facility never confirmed receipt. Routed to the DIS-DAL-02 facility manager. Inventory Ops remains primary owner; original SLA stands." },
      ...
      rule: "R-003",
      timeline: tl([["Open", "2026-05-27T05:10Z", "batch-validator"], ["Sub-assigned → Field Ops (DIS-DAL-02 Manager)", "2026-05-28T10:00Z", "Priya Nair"]])
    },
  ...
  // ---- Error trend over last 21 days: new exceptions flagged + auto-closed per day ----
  const trend = [
    { date: "2026-05-18", count: 8, autoClosed: 4 }, { date: "2026-05-19", count: 10, autoClosed: 6 },
    { date: "2026-05-20", count: 7, autoClosed: 5 }, { date: "2026-05-21", count: 12, autoClosed: 7 },
    { date: "2026-05-22", count: 9, autoClosed: 6 }, { date: "2026-05-23", count: 6, autoClosed: 4 },
    { date: "2026-05-24", count: 8, autoClosed: 5 }, { date: "2026-05-25", count: 9, autoClosed: 6 },
    { date: "2026-05-26", count: 11, autoClosed: 7 }, { date: "2026-05-27", count: 8, autoClosed: 5 },
    { date: "2026-05-28", count: 14, autoClosed: 8 }, { date: "2026-05-29", count: 10, autoClosed: 7 },
    { date: "2026-05-30", count: 13, autoClosed: 9 }, { date: "2026-05-31", count: 7, autoClosed: 5 },
    { date: "2026-06-01", count: 12, autoClosed: 8 }, { date: "2026-06-02", count: 9, autoClosed: 6 },
    { date: "2026-06-03", count: 11, autoClosed: 7 }, { date: "2026-06-04", count: 15, autoClosed: 9 },
    { date: "2026-06-05", count: 12, autoClosed: 8 }, { date: "2026-06-06", count: 10, autoClosed: 7 },
    { date: "2026-06-07", count: 13, autoClosed: 9 }
  ];

  // ---- Recurring-error leaderboard (fingerprint = errorType @ facility) over 30d ----
  // `trend`: rising / falling / flat relative to the prior 30-day window.
  const recurring = [
    { fingerprint: "NULL_PO_NUMBER @ DIS-ATL-01", errorType: "NULL_PO_NUMBER", facility: "DIS-ATL-01", count30d: 6, team: "Data Engineering", lastSeen: "2026-06-07", trend: "up" },
    { fingerprint: "MISSING_LOT_EXPIRATION @ IK-NYC-01", errorType: "MISSING_LOT_EXPIRATION", facility: "IK-NYC-01", count30d: 5, team: "Data Engineering", lastSeen: "2026-06-04", trend: "flat" },
    { fingerprint: "TRANSFER_WAREHOUSE_IMBALANCE @ TW-001", errorType: "TRANSFER_WAREHOUSE_IMBALANCE", facility: "TW-001", count30d: 4, team: "Inventory Ops", lastSeen: "2026-06-05", trend: "up" },
    { fingerprint: "THREE_WAY_MATCH_VARIANCE @ CK-CHI-01", errorType: "THREE_WAY_MATCH_VARIANCE", facility: "CK-CHI-01", count30d: 3, team: "Procurement", lastSeen: "2026-06-01", trend: "down" },
    { fingerprint: "NULL_PO_NUMBER @ DIS-DAL-02", errorType: "NULL_PO_NUMBER", facility: "DIS-DAL-02", count30d: 3, team: "Data Engineering", lastSeen: "2026-06-07", trend: "up" },
    { fingerprint: "CONVERSION_FACTOR_OUTLIER @ CK-CHI-01", errorType: "CONVERSION_FACTOR_OUTLIER", facility: "CK-CHI-01", count30d: 2, team: "Procurement", lastSeen: "2026-05-31", trend: "flat" }
  ];
